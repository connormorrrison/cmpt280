...
public class LinkedList280<I> implements SimpleList280<I> {
	...
	public String toString() {
		...
		// Use an iterator here so that we don't disturb the cursor.
		// Moving the cursor will crash the IntelliJ debugger because it calls toString()
		// to generate string representations for debugger watches, so this needs to be thread-safe.
		LinkedIterator280<I> iter = this.iterator();
