	...
	implements Searchable280<I>, Dispenser280<I>
{
	...
	public static void main(String[] args) {
		...
		T.search(9);
		if( T.cur.item().compareTo(9) != 0 ) System.out.println("Error: current item should be 9.");
		T.deleteItem();
		System.out.println(T);
		T.search(11);
		if( T.cur.item().compareTo(11) != 0 ) System.out.println("Error: current item should be 11.");
		T.deleteItem();
		System.out.println(T);
