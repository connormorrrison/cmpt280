...
public abstract class GraphWithCursors280<V extends Vertex280, E extends Edge280<V>>
	...
	public abstract GraphEdgeIterator280<V, E> eIterator();
	...
	public GraphVertexIterator280<V> iterator() {
		return new GraphVertexIterator280<>(this);
	}
	...
	public String toString() {
		GraphVertexIterator280<V> it = iterator();
		GraphEdgeIterator280<V, E> eIt = eIterator();
		...
		while (!it.after()) {
			...
			eIt.goFirst(it.item());
			while (!eIt.after()) {
				result.append(" " + eIt.item().toStringGraphIO(it.item()));
				eIt.goForth();
			}
			// result.append(" 0");
			it.goForth();
